...
export const projects: Project[] = [
  {
    ...
    imagePlaceholder: 'Real-Time Streaming & ELT Architecture',
  ...
  },
  {
    ...
    title: 'Autonomous Support Agent System',
    tagline: 'LLM-powered workflow automation reducing Tier 1 support tickets.',
    category: 'AI & Automation',
    imagePlaceholder: 'Context-Aware RAG Agent Pipeline',
  ...
  },
  {
    ...
    title: 'Global Logistics & Supply Chain Portal',
    tagline: 'Custom SaaS platform for international supply chain tracking.',
    category: 'Software Development',
    imagePlaceholder: 'Global Telemetry & Shipment Operations Dashboard',
